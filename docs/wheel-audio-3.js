 ...
 * Mix v3 — tanpura 0.055, tabla 0.38. Ektaal 12 matras @ 45 BPM.
 */
(function () {
  ...
  function startTanpura() {
    ...
    const strings = [
      { freq: SA, gain: 0.55, detune: -4 },
      { freq: SA, gain: 0.45, detune: 5 },
      { freq: PA, gain: 0.38, detune: -2 },
      { freq: SA_HIGH, gain: 0.18, detune: 3 },
    ];
